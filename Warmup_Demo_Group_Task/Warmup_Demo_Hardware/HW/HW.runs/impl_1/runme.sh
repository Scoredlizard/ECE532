...
HD_PWD='C:/Users/Callum/Repository_Code/ECE532/Warmup_Demo_Group_Task/Warmup_Demo_Hardware/HW/HW.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Demo_HW_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Demo_HW_wrapper.tcl -notrace
