...
HD_PWD='C:/Users/Callum/Repository_Code/ECE532/Warmup_Demo_Group_Task/Warmup_Demo_Hardware/HW/HW.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Demo_HW_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Demo_HW_wrapper.tcl
