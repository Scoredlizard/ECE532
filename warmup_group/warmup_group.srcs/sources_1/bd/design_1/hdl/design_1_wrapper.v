...
module design_1_wrapper
  ...
  input [0:0]BTND_tri_i;
  input [0:0]BTNL_tri_i;
  input [0:0]BTNR_tri_i;
  ...
  design_1 design_1_i
       (.BTNC_tri_i(BTNC_tri_i),
        .BTND_tri_i(BTND_tri_i),
        .BTNL_tri_i(BTNL_tri_i),
        .BTNR_tri_i(BTNR_tri_i),
